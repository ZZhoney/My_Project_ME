<template>
  <header class="header">
    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <a href="/" class="navbar-link" @click="logOut" v-if="nickName">Log  out</a>
    ...
    <!--登录框-->
    <div class="md-modal modal-msg modal-msg  md-modal-transition  "  v-bind:class="{'md-show':loginModalFlag}">//md-show
          ...
          <div class="confirm-tips">
            ...
            <ul>
              <li class="regi_form_input">
                <i class="icon_IconPeople"></i>
                <input type="text" tabindex="1" name="loginname"  v-model="userName"  class="regi_login_input  refi_login_input_left">
              </li>
              <li class="regi_form_input_noMargin">
                <i class="iconPwd"></i>
                <input type="password" tabindex="2" name="password" v-model="userPwd" @keyup.enter="loginModalFlag" class="regi_login_input  regi_login_input_right ">
              </li>
            </ul>
          </div>
...
//         nickName:''
     ...
     computed:{
       ...mapState(['nickName','cartCount'])//简写的方式
//       nickName(){
