        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li  v-for="(item ,index) in addressListFilter"  v-bind:class="{'check':checkIndex==index}"  @click="checkIndex=index" ><!--定义一个选中的索引，和当前选中的索引相同，再加一个class-->
                    <dl>
                      <dt>{{item.userName}}</dt>
                      <dd class="address">{{item.addressList}}</dd>
...
<script>
  ...
  import {currency} from './../util/currency'//带名字的导入
